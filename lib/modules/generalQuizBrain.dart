import 'package:wakapost/modules/question.dart';
import 'dart:math';
...
class QuizBrain {
  ...
  int _questionNumber = randomNumber.nextInt(20);

  List<Question> _questionBank = [
    Question(questionText: "Is Trump Stupid?", questionAnswer: false),
    Question(questionText: "Donald Trump is the fourth President of the United States to be impeached", questionAnswer: false),
    Question(questionText: "Martin Luther King was born in Florida", questionAnswer: false),
    Question(questionText: "Lightening does not strike the same place twice", questionAnswer: false),
    Question(questionText: "Birds are dinosaurs", questionAnswer: true),
    ...
    Question(questionText:
        'No piece of square dry paper can be folded in half more than 7 times.', questionAnswer:
        false),
    Question(questionText:
  ...
  void reset() {
    _questionNumber = randomNumber.nextInt(5);
  }
